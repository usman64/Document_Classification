...
for n in rogefiles:
	...
	scoreRowTemp = mis.pixel_sim("rowpng/rowTemplate.png", imageB)
	compare.append(scoreRowTemp)

	scoreRosTemp = mis.pixel_sim("rospng/rosTemplate.png", imageB)
	compare.append(scoreRosTemp)

	scoreRogeTemp = mis.pixel_sim("rogepng/rogeTemplate.png", imageB)
