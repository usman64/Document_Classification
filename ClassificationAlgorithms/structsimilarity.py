...
for n in rogefiles:
  ...
  scoreRowTemp = mis.structural_sim("rowpng/rowTemplate.png", imageB)
  compare.append(scoreRowTemp)

  scoreRosTemp = mis.structural_sim("rospng/rosTemplate.png", imageB)
  compare.append(scoreRosTemp)

  scoreRogeTemp = mis.structural_sim("rogepng/rogeTemplate.png", imageB)
