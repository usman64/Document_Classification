...
for n in rogefiles:
	...
	scoreRowTemp = mis.sift_sim("rowpng/rowTemplate.png", imageB)
	compare.append(scoreRowTemp)

	scoreRosTemp = mis.sift_sim("rospng/rosTemplate.png", imageB)
	compare.append(scoreRosTemp)

	scoreRogeTemp = mis.sift_sim("rogepng/rogeTemplate.png", imageB)
